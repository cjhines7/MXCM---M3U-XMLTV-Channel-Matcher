...
class MXMMApp:
    ...
    def _create_gui_layout(self):
        ...
        main_paned_window.add(top_frame, minsize=150)
        ...
        main_paned_window.sash_place(0, 0, 155)
    ...
    def _create_top_control_widgets(self, parent_frame):
        ...
        path_frame = tk.LabelFrame(left_col_frame, text="1. 📂 Select Folders", padx=5, pady=2)
        ...
        action_frame = tk.LabelFrame(left_col_frame, text="2. ⚡ Load & Process", padx=5, pady=2)
        ...
        settings_frame = tk.LabelFrame(right_col_frame, text="⚙️ Settings & Session", padx=5, pady=2)
        settings_frame.pack(fill="x", expand=False)
        tk.Label(settings_frame, text="🎯 Fuzzy Match Threshold:").pack()
